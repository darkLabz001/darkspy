...
class DarkSpy(object):
    ...
    def banner(self):
        c = self.color
        print("")
        print(c.red(1)+"    ____              ____        __  ___              "+c.reset())
        print(c.red(1)+"   / __ \__  ______  / __ \____  /  |/  /___  ____  __"+c.reset())
        print(c.red(1)+"  / / / / / / / __ \\/ /_/ / __ \/ /|_/ / __ \\/ __ \\/ /"+c.reset())
        print(c.red(1)+" / /_/ / /_/ / /_/ / _, _/ /_/ / /  / / /_/ / / / / / "+c.reset())
        print(c.red(1)+"/_____/\\__,_/ .___/_/ |_|\\____/_/  /_/\\____/_/ /_/_/  "+c.reset())
        print(c.red(1)+"           /_/                                        "+c.reset())
